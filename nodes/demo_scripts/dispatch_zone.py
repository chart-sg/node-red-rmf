...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        description = {}
        description['zone'] = self.args.zone_name
        if (self.args.zone_entry_types != ''):
            description['types'] = self.args.zone_entry_types
        if (self.args.places != ''):
            ds = []
            for i in range(len(self.args.places)):
                ...
                ds.append(d)
            description['places'] = ds
        if (self.args.facing):
            description['facing'] = self.args.facing*math.pi/180.0
